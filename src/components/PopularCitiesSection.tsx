...
export default function PopularCitiesSection() {
  ...
  return (
    <section className="h-2/3 w-full bg-neutral-200 rounded-lg p-4">
      <h3 className="text-[1.2rem] text-neutral-700 font-medium mb-1 flex items-center gap-x-4 border-b border-neutral-400 pb-4">
